	...
	<div>
		...
		<!-- {{value}} -->
			...
			<div style="display: flex;align-items: center;">
				...
				<varialeSelect  v-model="value.fieldValue" :size="size" height="" :valueType="mixinGetvalueType(value.fieldId)" :variableType.sync="value.variableType" width="255px"></varialeSelect>
